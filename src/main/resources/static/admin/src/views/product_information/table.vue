<template>
	<el-main class="bg table_wrap comtabel_t">
			...
			<el-row class="rows row1">
				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="商品类型">
						<el-select v-model="query.product_type">
							<el-option v-for="o in list_product_type" :key="o.type_name" :label="o.type_name" :value="o.type_name">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="商品价格">
						<el-input-number v-model="query.commodity_price"></el-input-number>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row class="rows row2">
				...
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
					...
					<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button
							v-if="user_group == '管理员' || $check_action('/product_information/table', 'del') || $check_action('/product_information/view', 'del')"
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%"
			...
			<el-table-column prop="product_introduction" @sort-change="$sortChange" label="商品简介"
				v-if="user_group == '管理员' || $check_field('get', 'product_introduction')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200"
				v-if="user_group == '管理员' || $check_action('/product_information/table', 'set') || $check_action('/product_information/view', 'set') || $check_action('/product_information/view', 'get') || $check_action('//table', 'add') || $check_action('//view', 'add')">
