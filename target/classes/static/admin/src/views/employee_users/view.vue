		...
		<el-row class="row_ce"> 
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="用户姓名" prop="user_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['employee_users_id'] && $check_field('set','user_name')) || (!form_sub['employee_users_id'] && $check_field('add','user_name'))"></el-input>
				...
				<el-form-item label="用户性别" prop="user_gender">
						...
						v-if="user_group === '管理员' || (form_sub['employee_users_id'] && $check_field('set','user_gender')) || (!form_sub['employee_users_id'] && $check_field('add','user_gender'))">
				...
				<el-form-item label="手机号码" prop="mobile_phone_number">
						...
						v-if="user_group === '管理员' || (form_sub['employee_users_id'] && $check_field('set','mobile_phone_number')) || (!form_sub['employee_users_id'] && $check_field('add','mobile_phone_number'))">
					</el-input>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/employee_users/view','set') || $check_action('/employee_users/view','add') || $check_option('/employee_users/table','examine')">
